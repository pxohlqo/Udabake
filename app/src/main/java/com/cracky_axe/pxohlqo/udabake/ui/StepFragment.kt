 ...
 * [StepFragment.OnFragmentInteractionListener] interface
...
class StepFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val stepDescriptionTextView = view.findViewById<TextView>(R.id.step_fragment_step_textview)
        stepDescriptionTextView.text = description
        return view
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(description: String, id: Int) =
                StepFragment().apply {
